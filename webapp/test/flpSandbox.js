		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Etiqueta Ubicación",
									"targetURL": "#etiquetaubicacion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"etiquetaubicacion-display": {
								"semanticObject": "etiquetaubicacion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=etiqueta.ubicacion",
									"url": sap.ui.require.toUrl("etiqueta/ubicacion")
								}
							}
						}
					}
